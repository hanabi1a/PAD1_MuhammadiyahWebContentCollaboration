    ...
    <div class="container-fluid px-5 px-5 mt-sm-2 mb-sm-2">
        <section id="akun-user">
            <div class="card">
                <div class="container">
                    <div class="card-form">
                    <h1 class="heading3 title-form"><strong>Ubah Kajian</strong></h1>
                        <div class="card-body">
                        <h1 class="heading4 mb-3"><strong>Data Kajian</strong></h1>
                            <div class="form-validation">
                                <form class="form-valide" action="{{ route('kajian.store') }}" method="POST"
                                    ...
                                    <!-- Kajian Referensi -->
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="val-pemateri">Kajian Referensi</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="val-kajian-referensi"
                                                name="val_kajian_referensi" placeholder="Kajian Referensi">
                                        </div>
                                    </div>

                                    <!-- Kajian Asli -->
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="val-kajian-asli">Kajian Asli
                                        </label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="val-kajian-asli"
                                                name="val_kajian_asli" placeholder="Kajian Asli">
                                        </div>
                                    </div>
