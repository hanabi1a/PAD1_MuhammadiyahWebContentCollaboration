                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ route('update_kajian', ['id' => $kajian->id]) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" value="{{$kajian->judul_kajian}}"
                                        class="form-control input-default" id="val-judul" name="val_judul"
                                        placeholder="Judul">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" value="{{$kajian->pemateri}}" class="form-control input-default"
                                        id="val_pemateri" name="val_pemateri" placeholder="Pemateri">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control input-default"
                                        value="{{$kajian->lokasi_kajian}}" id="val-tempat" name="val_tempat"
                                        placeholder="Tempat">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="date" value="{{$kajian->tanggal_postingan}}"
                                        class="form-control input-default" id="val_tanggal" name="val_tanggal">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p class="text-upload-foto">Pastikan untuk mengunggah foto Anda dalam salah satu
                                        format:
                                        PNG, JPG, JPEG.</p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p class="text-upload-foto">Pastikan untuk mengunggah file Anda dalam salah satu
                                        format:
                                        PDF, DOC, DOCX.</p>
