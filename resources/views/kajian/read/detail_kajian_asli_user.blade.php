                ...
                <div class="container">
                    <div class="row">
                        <div class="content col-md-6 order-md-1 me-5">
                            <div class="row mb-3 ">
                                ...
                                <div class="account-detail row align-items-center">
                                    <div class="col-md-2">
                                        <a href="profile_user">
                                            <img class="pp-account" src="/assets/img/account-profile.png" alt="Foto tidak ada" style="border-radius: 50%; width: 50px;">
                                        </a>
                                    </div>
                                    <div class="name-account col-md-9 align-items-center" style="display: flex;">
                                        <a style="text-decoration:none; color: #000;" href="profile_user_2">
                                            <div class="nama">aisyahummaira</div>
                                        </a>
                                    </div>
                                </div>
                                <img src="/assets/img/kajiann-2.png" alt="" class="img-fluid">
                                </div>
                        ...
                        <div class="col-md-5 order-md-2">
                            <button type="submit" class="btn-green-submit btn-block">
                            ...
                            <div class="card mt-4 col-md-12">
                                <div class="bungkus-card">
                                    <div class="card-body-user">
                                        <div class="row mb-4">
                                            <h1 class="heading3 mb-5"><strong>Kajian Versi Baru</strong></h1>
                                            <div class="col-md-3">
                                                <img src="/assets/img/account-profile.png"
                                            ...
                                            <div class="postingan col-md-9">
                                                <div class="row">
                                                    <div class="col-md-10 mt-3">
                                                        <p class="username-kajian-baru">Karthi Madesh</p>
                                                    </div>
