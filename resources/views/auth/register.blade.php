                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-7">
                            ...
                            @switch($page)
                                @case(1)
                                    <!-- Form Slide 2 -->
                                    <form id="form2" action="{{ route('register.step2') }}" method="post" enctype="multipart/form-data" class="form-slide">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3 mt-3">
                                                ...
                                                <div class="custom-control custom-radio mt-2">
                                                    <input type="radio" id="jenis_kelamin_perempuan" 
                                                        name="jenis_kelamin"
                                                ...
                                                <div class="custom-control custom-radio mt-3">
                                                    <input type="radio" id="jenis_kelamin_laki" 
                                                        name="jenis_kelamin"
                                ...
                                @case(2)
                                    <!-- Form Slide 3 -->
                                    <form id="form3" action="{{ route('register.step3') }}" method="post" enctype="multipart/form-data" class="form-slide">
                                        <h3 class="heading1"><strong>Daftar Akun</strong></h3>
                                        @csrf
                                ...
                                @case(3)
                                    <!-- Form Slide 4 -->
                                    <form id="form4" action="{{ route('register.step4') }}" method="post" enctype="multipart/form-data" class="form-slide">
