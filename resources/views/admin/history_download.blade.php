        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow active" href="history_download" aria-expanded="false">
...
<div class="content-body">
    ...
    <div class="container-fluid mt-3">
        <p class="text_page">Dashboard / History Download</p>
        <h2 class="text_title">History Download</h2>
        <!-- row -->
