...
@section('content')
<main> <div class="container-fluid px-4"> <h1 class="mt-5">Create Kajian</h1> <ol class="breadcrumb mt-2"> <li
    class="text_page breadcrumb"><a href="dashboard">Dashboard / </a>
    <a href="data_kajian" class="active_title">
     Data Kajian /</a><a href="data_kajian" class="active_title"> Create Kajian</a></li>
    </ol>
            ...
            <div class="form-validation">
                <form class="form-valide" action="#" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control input-default" id="val-pemateri" name="val-pemateri"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6" style="display: flex; align-items: center;">
                            <input type="text" class="form-control input-default" id="val-tanggal" name="val-tanggal"
                                placeholder="Tanggal">
