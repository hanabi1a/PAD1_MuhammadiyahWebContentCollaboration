...
@section('content')
<main> <div class="container-fluid px-4"> <h1 class="mt-5">Manajemen Kajian</h1>
    <ol class="breadcrumb mt-2">
    <li class="text_page breadcrumb"><a href="dashboard">Dashboard /</a><a href="data_kajian" class="active_title"> Data Kajian</a></li>
    </ol>

    <div class="card mb-4">
    <div class="card-header text-white d-flex justify-content-between align-items-center">
        <a href="form_create_admin" class="btn btn-danger">Create</a>
    </div>
